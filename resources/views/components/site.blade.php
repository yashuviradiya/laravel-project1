            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        <li><a href="{{route('front.shopdetails')}}">Shop Details</a></li>
                        <li><a href="{{route('front.shopdetails')}}">Shop Details</a></li>
                        <li><a href="{{route('front.shopingcart')}}">Shoping Cart</a></li>
                        <li><a href="{{route('front.checkout')}}">Check Out</a></li>
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="{{route('front.shop')}}">Shop</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="header__menu__dropdown">
                                    <li><a href="{{route('front.shopdetails')}}">Shop Details</a></li>
                                    <li><a href="{{route('front.shopingcart')}}">Shoping Cart</a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: 60-49 Road 11378 New Yor</li>
